    ...
    <div>
      ...
      <div className="foro-contenedor">
        ...
        <div className="formulario-pregunta">
          <label className="titulo-editable" >
            <b>Titulo de la pregunta</b>
          </label>
          <input
            type="text"
  ...
  {preguntas
    ...
    .map((pregunta) => (
      <div key={pregunta._id} className="pregunta-item">
        ...
        <p><strong>Autor: {pregunta.autor}</strong></p>
        <p>{pregunta.contenido}</p>
        <p className="fecha">
            {new Date(pregunta.fecha).toLocaleString("es-MX", {
                dateStyle: "short",
                timeStyle: "short",
            })}
        </p>
        ...
        <div className="respuesta">
          ...
          {pregunta.comentarios && pregunta.comentarios.length > 0 ? (
            <>
              <p>{pregunta.comentarios[0].contenido}</p>
              <p className="fecha-respuesta">
                <em>
                Fecha de respuesta:{" "}
                    {new Date(pregunta.comentarios[0].fecha).toLocaleString("es-MX", {
                    dateStyle: "short",
                    timeStyle: "short",
                    })}
                </em>
